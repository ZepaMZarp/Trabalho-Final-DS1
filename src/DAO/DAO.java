...
public class DAO {
    ...
    public String[] getCamposBD(String tableName, boolean incluirAtributosAI) {
        switch (tableName) {
            ...
            case "JOGO":
                if (incluirAtributosAI) {
                    return new String[]{"ID", "NOME", "DESCRICAO", "MIN_REQ_PROCESSADOR", "MIN_REQ_MEMORIA", "MIN_REQ_PLACA_VIDEO", "REQ_SISTEMA_OPERACIONAL_1", "REQ_SISTEMA_OPERACIONAL_2", "REQ_SISTEMA_OPERACIONAL_3", "PRECISA_WIRELESS", "PRECISA_WEBCAM", "PRECO"};
                } else {
                    return new String[]{"NOME", "DESCRICAO", "MIN_REQ_PROCESSADOR", "MIN_REQ_MEMORIA", "MIN_REQ_PLACA_VIDEO", "REQ_SISTEMA_OPERACIONAL_1", "REQ_SISTEMA_OPERACIONAL_2", "REQ_SISTEMA_OPERACIONAL_3", "PRECISA_WIRELESS", "PRECISA_WEBCAM", "PRECO"};
                }
            case "MEMORIA":
                if (incluirAtributosAI) {
